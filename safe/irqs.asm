...
set_irq_handler:	;esi == handler #, ebx == function address. To remove a handler, just set the function address to null.
	push esi
	push ebx
	shl esi, 2
...
master_irq_handler:
	...
	mov al, 20H			;otherwise output this special opcode (to the pic (master: controls 1-7))
	out 0A0H, al
	.end:
